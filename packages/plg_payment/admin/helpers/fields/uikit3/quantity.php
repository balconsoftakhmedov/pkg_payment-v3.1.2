...
class RSFormProFieldUikit3Quantity extends RSFormProFieldQuantity
{
	...
	{
		require_once JPATH_ADMINISTRATOR . '/components/com_rsform/helpers/fields/uikit3/textbox.php';

		$field = new RSFormProFieldUikit3Textbox($config);
